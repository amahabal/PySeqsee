"""Adapting the generic FARG GUI to Test."""

from farg.apps.test.gui.workspace_view import WorkspaceView
...
class TestCentralPane(CentralPane):
...
class TestGUI(GUI):
  ...
  central_pane_class = TestCentralPane
