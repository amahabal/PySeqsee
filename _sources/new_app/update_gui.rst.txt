...
The UI is implemented in Tkinter, and all components are drawn on a Canvas. Depending on the selected
view (something you can change using the menu at the top left), the full canvas or only a fraction
of it is alloted to the workspace view.
